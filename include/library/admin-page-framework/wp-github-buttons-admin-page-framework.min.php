...
final class WPGithubButtons_AdminPageFramework_Registry extends WPGithubButtons_AdminPageFramework_Registry_Base {
    ...
    static public function setUp($sFilePath = null) {
        ...
        self::$sAutoLoaderPath = self::$sDirPath . '/factory/WPGithubButtons_AdminPageFramework_Factory/utility/WPGithubButtons_AdminPageFramework_RegisterClasses.php';
...
final class WPGithubButtons_AdminPageFramework_Bootstrap {
    public function __construct($sLibraryPath) {
        ...
        include (WPGithubButtons_AdminPageFramework_Registry::$sDirPath . '/admin-page-framework-include-class-list.php');
        new WPGithubButtons_AdminPageFramework_RegisterClasses(isset($aClassFiles) ? '' : WPGithubButtons_AdminPageFramework_Registry::$sDirPath, array('exclude_class_names' => 'WPGithubButtons_AdminPageFramework_MinifiedVersionHeader',), isset($aClassFiles) ? $aClassFiles : array());
    }
}
new WPGithubButtons_AdminPageFramework_Bootstrap(__FILE__);
abstract class WPGithubButtons_AdminPageFramework_Form_Model_Export extends WPGithubButtons_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new WPGithubButtons_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
...
abstract class WPGithubButtons_AdminPageFramework_Form_Model_Validation_Opiton extends WPGithubButtons_AdminPageFramework_Form_Model_Export {
...
abstract class WPGithubButtons_AdminPageFramework_Form_Model_Validation extends WPGithubButtons_AdminPageFramework_Form_Model_Validation_Opiton {
...
abstract class WPGithubButtons_AdminPageFramework_Form_Model extends WPGithubButtons_AdminPageFramework_Form_Model_Validation {
    ...
    public function _replyToSendFormEmail() {
        ...
        $_oEmail = new WPGithubButtons_AdminPageFramework_FormEmail($_aFormEmail['email_options'], $_aFormEmail['input'], $_aFormEmail['section_id']);
        $_bSent = $_oEmail->send();
        exit;
    }
...
abstract class WPGithubButtons_AdminPageFramework_Form_View extends WPGithubButtons_AdminPageFramework_Form_Model {
    ...
    public function _replyToGetFieldOutput($aField) {
        ...
        $_oField = new WPGithubButtons_AdminPageFramework_FormField($aField, $_aTemp, $this->aFieldErrors, $this->oProp->aFieldTypeDefinitions, $this->oMsg);
...
abstract class WPGithubButtons_AdminPageFramework_Form_Controller extends WPGithubButtons_AdminPageFramework_Form_View {
    ...
    public function getValue() {
        ...
        return WPGithubButtons_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aDimensionalKeys) ? null : $_aDimensionalKeys, null, $this->getSavedOptions() + $this->oProp->getDefaultOptions($this->oForm->aFields));
    }
...
abstract class WPGithubButtons_AdminPageFramework_Page_Model extends WPGithubButtons_AdminPageFramework_Form_Controller {
...
abstract class WPGithubButtons_AdminPageFramework_Page_View_MetaBox extends WPGithubButtons_AdminPageFramework_Page_Model {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['aWPGithubButtons_AdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['aWPGithubButtons_AdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['aWPGithubButtons_AdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['aWPGithubButtons_AdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['aWPGithubButtons_AdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['aWPGithubButtons_AdminPageFramework']['bAddedMetaBoxScript'] = true;
...
abstract class WPGithubButtons_AdminPageFramework_Page_View extends WPGithubButtons_AdminPageFramework_Page_View_MetaBox {
    ...
    private function _getFormOutput($sPageSlug) {
        ...
        $_oFieldsTable = new WPGithubButtons_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->aFieldErrors, $this->oMsg);
...
abstract class WPGithubButtons_AdminPageFramework_Page_Controller extends WPGithubButtons_AdminPageFramework_Page_View {
...
abstract class WPGithubButtons_AdminPageFramework_Menu_Model extends WPGithubButtons_AdminPageFramework_Page_Controller {
...
abstract class WPGithubButtons_AdminPageFramework_Menu_View extends WPGithubButtons_AdminPageFramework_Menu_Model {
}
abstract class WPGithubButtons_AdminPageFramework_Menu_Controller extends WPGithubButtons_AdminPageFramework_Menu_View {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
...
abstract class WPGithubButtons_AdminPageFramework_Model extends WPGithubButtons_AdminPageFramework_Menu_Controller {
}
abstract class WPGithubButtons_AdminPageFramework_View extends WPGithubButtons_AdminPageFramework_Model {
...
abstract class WPGithubButtons_AdminPageFramework_Controller extends WPGithubButtons_AdminPageFramework_View {
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return WPGithubButtons_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class WPGithubButtons_AdminPageFramework extends WPGithubButtons_AdminPageFramework_Controller {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        parent::__construct($sOptionKey, $sCallerPath ? trim($sCallerPath) : $sCallerPath = (is_admin() && (isset($GLOBALS['pagenow']) && in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page'])) ? WPGithubButtons_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null), $sCapability, $sTextDomain);
        $this->oUtil->addAndDoAction($this, 'start_' . $this->oProp->sClassName, $this);
    }
}
abstract class WPGithubButtons_AdminPageFramework_NetworkAdmin extends WPGithubButtons_AdminPageFramework {
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_network', $sTextDomain = 'admin-page-framework') {
        ...
        $sCallerPath = $sCallerPath ? $sCallerPath : WPGithubButtons_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        $this->oProp = new WPGithubButtons_AdminPageFramework_Property_NetworkAdmin($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return WPGithubButtons_AdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
}
...
abstract class WPGithubButtons_AdminPageFramework_Router extends WPGithubButtons_AdminPageFramework_Factory {
    function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        $this->oProp = isset($this->oProp) ? $this->oProp : new WPGithubButtons_AdminPageFramework_Property_Page($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
...
abstract class WPGithubButtons_AdminPageFramework_Form_Model_Import extends WPGithubButtons_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new WPGithubButtons_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
...
abstract class WPGithubButtons_AdminPageFramework_MetaBox_Router extends WPGithubButtons_AdminPageFramework_Factory {
    function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        ...
        $_sClassName = get_class($this);
        parent::__construct(isset($this->oProp) ? $this->oProp : new WPGithubButtons_AdminPageFramework_Property_MetaBox($this, $_sClassName, $sCapability));
...
abstract class WPGithubButtons_AdminPageFramework_MetaBox_Model extends WPGithubButtons_AdminPageFramework_MetaBox_Router {
...
abstract class WPGithubButtons_AdminPageFramework_PostType_Router extends WPGithubButtons_AdminPageFramework_Factory {
    public function _isInThePage() {
        if (!$this->oProp->bIsAdmin) {
            return false;
        }
...
abstract class WPGithubButtons_AdminPageFramework_PostType_Model extends WPGithubButtons_AdminPageFramework_PostType_Router {
    function __construct($oProp) {
        parent::__construct($oProp);
...
abstract class WPGithubButtons_AdminPageFramework_TaxonomyField_Router extends WPGithubButtons_AdminPageFramework_Factory {
    public function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->oProp->bIsAdmin) {
...
abstract class WPGithubButtons_AdminPageFramework_TaxonomyField_Model extends WPGithubButtons_AdminPageFramework_TaxonomyField_Router {
...
abstract class WPGithubButtons_AdminPageFramework_UserMeta_Router extends WPGithubButtons_AdminPageFramework_Factory {
    public function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->oProp->bIsAdmin) {
            add_action('wp_loaded', array($this, '_replyToDetermineToLoad'));
...
abstract class WPGithubButtons_AdminPageFramework_UserMeta_Model extends WPGithubButtons_AdminPageFramework_UserMeta_Router {
    public function _replyToRegisterFormElements($oScreen) {
        $this->_loadFieldTypeDefinitions();
        $this->oForm->format();
        $this->oForm->applyConditions();
...
abstract class WPGithubButtons_AdminPageFramework_MetaBox_View extends WPGithubButtons_AdminPageFramework_MetaBox_Model {
...
abstract class WPGithubButtons_AdminPageFramework_MetaBox_Controller extends WPGithubButtons_AdminPageFramework_MetaBox_View {
    public function setUp() {
    }
...
abstract class WPGithubButtons_AdminPageFramework_MetaBox extends WPGithubButtons_AdminPageFramework_MetaBox_Controller {
    static protected $_sFieldsType = 'post_meta_box';
    function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        $this->oProp = new WPGithubButtons_AdminPageFramework_Property_MetaBox($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
abstract class WPGithubButtons_AdminPageFramework_PostType_View extends WPGithubButtons_AdminPageFramework_PostType_Model {
    function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->_isInThePage()) {
...
abstract class WPGithubButtons_AdminPageFramework_PostType_Controller extends WPGithubButtons_AdminPageFramework_PostType_View {
    public function __construct($oProp) {
        parent::__construct($oProp);
        if (did_action('init')) {
            $this->setup_pre();
...
abstract class WPGithubButtons_AdminPageFramework_PostType extends WPGithubButtons_AdminPageFramework_PostType_Controller {
    public function __construct($sPostType, $aArgs = array(), $sCallerPath = null, $sTextDomain = 'admin-page-framework') {
        if (empty($sPostType)) {
            return;
        }
        $this->oProp = new WPGithubButtons_AdminPageFramework_Property_PostType($this, $sCallerPath ? trim($sCallerPath) : ((is_admin() && isset($GLOBALS['pagenow']) && in_array($GLOBALS['pagenow'], array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php',))) ? WPGithubButtons_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null), get_class($this), 'publish_posts', $sTextDomain, 'post_type');
        $this->oProp->sPostType = WPGithubButtons_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
        $this->oProp->aPostTypeArgs = $aArgs;
        parent::__construct($this->oProp);
        $this->oUtil->addAndDoAction($this, "start_{$this->oProp->sClassName}", $this);
    }
}
abstract class WPGithubButtons_AdminPageFramework_TaxonomyField_View extends WPGithubButtons_AdminPageFramework_TaxonomyField_Model {
...
abstract class WPGithubButtons_AdminPageFramework_TaxonomyField_Controller extends WPGithubButtons_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class WPGithubButtons_AdminPageFramework_TaxonomyField extends WPGithubButtons_AdminPageFramework_TaxonomyField_Controller {
    ...
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new WPGithubButtons_AdminPageFramework_Property_TaxonomyField($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
abstract class WPGithubButtons_AdminPageFramework_UserMeta_View extends WPGithubButtons_AdminPageFramework_UserMeta_Model {
    public function content($sContent) {
        return $sContent;
    }
...
abstract class WPGithubButtons_AdminPageFramework_UserMeta_Controller extends WPGithubButtons_AdminPageFramework_UserMeta_View {
    public function setUp() {
    }
    public function enqueueStyles($aSRCs, $aPostTypes = array(), $aCustomArgs = array()) {
        return $this->oResource->_enqueueStyles($aSRCs, $aPostTypes, $aCustomArgs);
...
abstract class WPGithubButtons_AdminPageFramework_UserMeta extends WPGithubButtons_AdminPageFramework_UserMeta_Controller {
    ...
    public function __construct($sCapability = 'edit_user', $sTextDomain = 'admin-page-framework') {
        $this->oProp = new WPGithubButtons_AdminPageFramework_Property_UserMeta($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
        parent::__construct($this->oProp);
        $this->oUtil->addAndDoAction($this, "start_{$this->oProp->sClassName}");
    }
}
...
abstract class WPGithubButtons_AdminPageFramework_MetaBox_Page_Router extends WPGithubButtons_AdminPageFramework_MetaBox_View {
...
abstract class WPGithubButtons_AdminPageFramework_MetaBox_Page_Model extends WPGithubButtons_AdminPageFramework_MetaBox_Page_Router {
    static protected $_sFieldsType = 'page_meta_box';
    function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        $this->oProp = new WPGithubButtons_AdminPageFramework_Property_MetaBox_Page($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
abstract class WPGithubButtons_AdminPageFramework_MetaBox_Page_View extends WPGithubButtons_AdminPageFramework_MetaBox_Page_Model {
}
abstract class WPGithubButtons_AdminPageFramework_MetaBox_Page_Controller extends WPGithubButtons_AdminPageFramework_MetaBox_Page_View {
    public function enqueueStyles($aSRCs, $sPageSlug = '', $sTabSlug = '', $aCustomArgs = array()) {
        if (method_exists($this->oResource, '_enqueueStyles')) {
            return $this->oResource->_enqueueStyles($aSRCs, $sPageSlug, $sTabSlug, $aCustomArgs);
        }
...
abstract class WPGithubButtons_AdminPageFramework_MetaBox_Page extends WPGithubButtons_AdminPageFramework_MetaBox_Page_Controller {
    function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
...
class WPGithubButtons_AdminPageFramework_Resource_Page extends WPGithubButtons_AdminPageFramework_Resource_Base {
    protected function _printClassSpecificStyles($sIDPrefix) {
...
class WPGithubButtons_AdminPageFramework_Resource_MetaBox extends WPGithubButtons_AdminPageFramework_Resource_Base {
...
class WPGithubButtons_AdminPageFramework_Resource_MetaBox_Page extends WPGithubButtons_AdminPageFramework_Resource_Page {
}
class WPGithubButtons_AdminPageFramework_Resource_PostType extends WPGithubButtons_AdminPageFramework_Resource_MetaBox {
}
class WPGithubButtons_AdminPageFramework_Resource_TaxonomyField extends WPGithubButtons_AdminPageFramework_Resource_MetaBox {
...
class WPGithubButtons_AdminPageFramework_Resource_UserMeta extends WPGithubButtons_AdminPageFramework_Resource_MetaBox {
}
...
final class WPGithubButtons_AdminPageFramework_MinifiedVersionHeader extends WPGithubButtons_AdminPageFramework_Registry_Base {
...
class WPGithubButtons_AdminPageFramework_Property_Page extends WPGithubButtons_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aWPGithubButtons_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['aWPGithubButtons_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aWPGithubButtons_AdminPageFramework']['aPageClasses']) ? $GLOBALS['aWPGithubButtons_AdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['aWPGithubButtons_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
...
class WPGithubButtons_AdminPageFramework_Property_MetaBox extends WPGithubButtons_AdminPageFramework_Property_Base {
...
class WPGithubButtons_AdminPageFramework_Property_PostType extends WPGithubButtons_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        switch ($this->_getCallerType($sCallerPath)) {
            case 'theme':
                add_action('after_switch_theme', array('WPGithubButtons_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
            break;
            case 'plugin':
                register_activation_hook($sCallerPath, array('WPGithubButtons_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
                register_deactivation_hook($sCallerPath, array('WPGithubButtons_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
            break;
        }
    }
}
...
class WPGithubButtons_AdminPageFramework_Property_NetworkAdmin extends WPGithubButtons_AdminPageFramework_Property_Page {
    public $_sPropertyType = 'network_admin_page';
    public $sFieldsType = 'network_admin_page';
    protected function _getOptions() {
        return WPGithubButtons_AdminPageFramework_WPUtility::addAndApplyFilter($GLOBALS['aWPGithubButtons_AdminPageFramework']['aPageClasses'][$this->sClassName], 'options_' . $this->sClassName, $this->sOptionKey ? get_site_option($this->sOptionKey, array()) : array());
    }
    public function updateOption($aOptions = null) {
        if ($this->_bDisableSavingOptions) {
            return;
...
class WPGithubButtons_AdminPageFramework_Property_MetaBox_Page extends WPGithubButtons_AdminPageFramework_Property_MetaBox {
    ...
    function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework', $sFieldsType = 'page_meta_box') {
        ...
        $GLOBALS['aWPGithubButtons_AdminPageFramework']['aMetaBoxForPagesClasses'] = isset($GLOBALS['aWPGithubButtons_AdminPageFramework']['aMetaBoxForPagesClasses']) && is_array($GLOBALS['aWPGithubButtons_AdminPageFramework']['aMetaBoxForPagesClasses']) ? $GLOBALS['aWPGithubButtons_AdminPageFramework']['aMetaBoxForPagesClasses'] : array();
        $GLOBALS['aWPGithubButtons_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        if (!isset($GLOBALS['aWPGithubButtons_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        if (!is_array($GLOBALS['aWPGithubButtons_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        foreach ($GLOBALS['aWPGithubButtons_AdminPageFramework']['aPageClasses'] as $__oClass) {
...
class WPGithubButtons_AdminPageFramework_Property_TaxonomyField extends WPGithubButtons_AdminPageFramework_Property_MetaBox {
    public $_sPropertyType = 'taxonomy_field';
    public $aTaxonomySlugs;
    public $sOptionKey;
}
class WPGithubButtons_AdminPageFramework_Property_UserMeta extends WPGithubButtons_AdminPageFramework_Property_MetaBox {
...
abstract class WPGithubButtons_AdminPageFramework_CustomSubmitFields extends WPGithubButtons_AdminPageFramework_WPUtility {
    public $aPost = array();
    public $sInputID;
...
class WPGithubButtons_AdminPageFramework_FormEmail extends WPGithubButtons_AdminPageFramework_WPUtility {
...
class WPGithubButtons_AdminPageFramework_Link_Page extends WPGithubButtons_AdminPageFramework_Link_Base {
    public $oProp;
...
class WPGithubButtons_AdminPageFramework_FormElement_Page extends WPGithubButtons_AdminPageFramework_FormElement {
...
class WPGithubButtons_AdminPageFramework_Debug extends WPGithubButtons_AdminPageFramework_WPUtility {
    ...
    static private function _getLogHeadingLine($fCurrentTimeStamp, $nElapsed, $sCallerClass, $sCallerFunction) {
        ...
        $_aOutput = array(date("Y/m/d H:i:s", $_nNow) . '.' . $_nMicroseconds, self::_getFormattedElapsedTime($nElapsed), $_iPageLoadID, WPGithubButtons_AdminPageFramework_Registry::VERSION . (WPGithubButtons_AdminPageFramework_Registry::$bIsMinifiedVersion ? '.min' : ''), $sCallerClass . '::' . $sCallerFunction, current_filter(), self::getCurrentURL(),);
        return implode(' ', $_aOutput);
    }
...
class WPGithubButtons_AdminPageFramework_HelpPane_Page extends WPGithubButtons_AdminPageFramework_HelpPane_Base {
...
class WPGithubButtons_AdminPageFramework_ExportOptions extends WPGithubButtons_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo WPGithubButtons_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
...
class WPGithubButtons_AdminPageFramework_ImportOptions extends WPGithubButtons_AdminPageFramework_CustomSubmitFields {
...
class WPGithubButtons_AdminPageFramework_Link_PostType extends WPGithubButtons_AdminPageFramework_Link_Base {
    public $aFooterInfo = array('sLeft' => '', 'sRight' => '',);
    public function __construct($oProp, $oMsg = null) {
        if (!$oProp->bIsAdmin) {
            return;
...
class WPGithubButtons_AdminPageFramework_Link_NetworkAdmin extends WPGithubButtons_AdminPageFramework_Link_Page {
    public $oProp;
    public function __construct(&$oProp, $oMsg = null) {
        if (!$oProp->bIsAdmin) {
            return;
...
class WPGithubButtons_AdminPageFramework_HelpPane_MetaBox extends WPGithubButtons_AdminPageFramework_HelpPane_Base {
    function __construct($oProp) {
        parent::__construct($oProp);
        if ($oProp->bIsAdminAjax) {
            return;
...
class WPGithubButtons_AdminPageFramework_HelpPane_MetaBox_Page extends WPGithubButtons_AdminPageFramework_HelpPane_MetaBox {
    protected function _isInThePage() {
...
class WPGithubButtons_AdminPageFramework_HelpPane_TaxonomyField extends WPGithubButtons_AdminPageFramework_HelpPane_MetaBox {
    public function _replyToRegisterHelpTabTextForMetaBox() {
        $this->_setHelpTab($this->oProp->sMetaBoxID, $this->oProp->sTitle, $this->oProp->aHelpTabText, $this->oProp->aHelpTabTextSide);
    }
}
class WPGithubButtons_AdminPageFramework_HelpPane_UserMeta extends WPGithubButtons_AdminPageFramework_HelpPane_MetaBox {
}
...
class WPGithubButtons_AdminPageFramework_PageLoadInfo_Page extends WPGithubButtons_AdminPageFramework_PageLoadInfo_Base {
    private static $_oInstance;
    private static $aClassNames = array();
    public static function instantiate($oProp, $oMsg) {
        if (in_array($oProp->sClassName, self::$aClassNames)) return self::$_oInstance;
        self::$aClassNames[] = $oProp->sClassName;
        self::$_oInstance = new WPGithubButtons_AdminPageFramework_PageLoadInfo_Page($oProp, $oMsg);
...
class WPGithubButtons_AdminPageFramework_PageLoadInfo_NetworkAdminPage extends WPGithubButtons_AdminPageFramework_PageLoadInfo_Base {
    private static $_oInstance;
    private static $aClassNames = array();
    function __construct($oProp, $oMsg) {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        if (in_array($oProp->sClassName, self::$aClassNames)) return self::$_oInstance;
        self::$aClassNames[] = $oProp->sClassName;
        self::$_oInstance = new WPGithubButtons_AdminPageFramework_PageLoadInfo_NetworkAdminPage($oProp, $oMsg);
        return self::$_oInstance;
    }
    public function _replyToSetPageLoadInfoInFooter() {
        if ($this->oProp->isPageAdded()) {
...
class WPGithubButtons_AdminPageFramework_PageLoadInfo_PostType extends WPGithubButtons_AdminPageFramework_PageLoadInfo_Base {
    private static $_oInstance;
    private static $aClassNames = array();
    public static function instantiate($oProp, $oMsg) {
        if (in_array($oProp->sClassName, self::$aClassNames)) return self::$_oInstance;
        self::$aClassNames[] = $oProp->sClassName;
        self::$_oInstance = new WPGithubButtons_AdminPageFramework_PageLoadInfo_PostType($oProp, $oMsg);
        return self::$_oInstance;
    }
    public function _replyToSetPageLoadInfoInFooter() {
        ...
        if (WPGithubButtons_AdminPageFramework_WPUtility::getCurrentPostType() == $this->oProp->sPostType || WPGithubButtons_AdminPageFramework_WPUtility::isPostDefinitionPage($this->oProp->sPostType) || WPGithubButtons_AdminPageFramework_WPUtility::isCustomTaxonomyPage($this->oProp->sPostType)) {
            add_filter('update_footer', array($this, '_replyToGetPageLoadInfo'), 999);
        }
    }
}
